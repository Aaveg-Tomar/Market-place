    ...
    return (
        <div>
            ...
            <hr class="h-px my-8 bg-gray-200 border-1 dark:bg-gray-700"/>
                <h3 className=' text-5xl font-extrabold text-center m-8 text-gray-900' style={{fontFamily:'Bruno Ace'}}>{props.type}</h3>
                            ...
                            (props.type === e.type) ? (
                                <article className="card m-3">
                                    ...
                                    <div className="card__content | flow">
                                        ...
                                        <Link to={"/Service?" + e.proname}><button className="card__button">View Seller</button></Link>
